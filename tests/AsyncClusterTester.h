...
/* 
 * File:   AsyncClusterTester.h
 * Author: jwhh9
 *
 * Created on June 23, 2018, 8:05 PM
 */

#ifndef ASYNCCLUSTERTESTER_H
#define ASYNCCLUSTERTESTER_H
...
class AsyncClusterTester
{
public:
    AsyncClusterTester(const char *key_, const char *host_, const int port_, const int size): 
    ...
    static void callback(redisAsyncContext *ctx, void *r, void *privdata) 
    {
        ...
        AsyncClusterTester *instTester = (AsyncClusterTester*) privdata;
