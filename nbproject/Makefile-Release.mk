...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libRedisStructures.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libRedisStructures.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

${OBJECTDIR}/redisvector.o: redisvector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/redisvector.o redisvector.cpp
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/kd_test.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS}  -lann -lboost_timer -lboost_system 
...
${TESTDIR}/tests/kd_test.o: tests/kd_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/kd_test.o tests/kd_test.cpp
...
${OBJECTDIR}/redisvector_nomain.o: ${OBJECTDIR}/redisvector.o redisvector.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/redisvector_nomain.o redisvector.cpp;\
	else  \
